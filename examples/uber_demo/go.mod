module github.com/flanksource/clicky/examples/uber_demo

go 1.25.1

replace github.com/carlos7ags/folio => github.com/flanksource/folio v0.0.0-20260324144508-31bc46b977ea
...
require (
	...
	github.com/carlos7ags/folio v0.0.0 // indirect
