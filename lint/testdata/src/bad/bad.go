...
var directHeading = api.Heading{Level: 2, Content: api.Text{}.Append("H")} // want `avoid direct api\.Heading struct literal`
var directBlockquote = api.Blockquote{Content: api.Text{}.Append("quote")} // want `avoid direct api\.Blockquote struct literal`
var directAdmonition = api.Admonition{Severity: api.SeverityWarning}       // want `avoid direct api\.Admonition struct literal`
var directFootnoteRef = api.FootnoteRef{ID: "cash"}                        // want `avoid direct api\.FootnoteRef struct literal`
var directFootnote = api.Footnote{ID: "cash"}                              // want `avoid direct api\.Footnote struct literal`
var directFootnotes = api.Footnotes{Items: nil}                            // want `avoid direct api\.Footnotes struct literal`
